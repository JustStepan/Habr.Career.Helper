...
function EmailForm() {
    ...
    function handleSubmit(e) {
        ...
        setDisplayedText(email);  // Копируем текст для отображения
        setEmail('');  // Очищаем input (опционально)
    }

    return (
        <div className="max-w-2xl mx-auto p-8">
            <h4 className="font-bold tracking-tight text-slate-400 sm:text-2xl mb-2">Тестируем ввод mail</h4>
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex gap-2">
                    ...
                    <button 
                        type="submit"
                        className="px-6 p-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition"
                    >
                        Показать почту
                    </button>
                ...
                {displayedText && (
                    <div className="mt-4 p-4 bg-green-50 border rounded">
                        ...
                        <p className="text-gray-700">
                            Отображаемый mail: <b className="text-green-700">{displayedText}</b><br/>
