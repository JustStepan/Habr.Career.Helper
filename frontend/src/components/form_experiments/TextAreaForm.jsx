...
function TextAreaForm() {
    ...
    function handleSubmit(e) {
        ...
        setDisplayedText(message);  // Копируем текст для отображения
        setMessage('');  // Очищаем input (опционально)
    }

    return (
        <div className="max-w-2xl mx-auto p-8">
            <h4 className="font-bold tracking-tight text-slate-400 sm:text-2xl mb-2">Тестируем ввод сообщения</h4>
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className=" gap-2">
                    ...
                    <textarea 
                        ...
                        rows="4"
                        className="w-full flex px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    ...
                    <button 
                        type="submit"
                        className="px-6 p-2 mt-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition"
                    >
                        Показать сообщение
                    </button>
                ...
                {displayedText && (
                    <div className="mt-4 p-4 bg-green-50 border rounded">
                        ...
                        <p className="text-gray-700">
                            Сообщение: <b className="text-green-700">{displayedText}</b><br/>
